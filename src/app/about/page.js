...
export default function AboutPage() {
  ...
  const timeline = [
    {
      ...
      description:
        "Started as a small street-side corner in Kohat, serving authentic chicken broast with secret family recipes.",
      icon: "🔥",
    },
    {
      year: "2015",
      title: "Arabian Mandi Revolution",
      description:
        "Introduced Kohat's first authentic underground Arabian Mandi, cooked in traditional clay ovens.",
      icon: "🏺",
    },
    {
      year: "2020",
      ...
      description:
        "Expanded to a state-of-the-art premium dine-in facility seating 300+ guests.",
      icon: "🏛️",
    },
    {
      year: "2024",
      ...
      description:
        "Launched online ordering and delivery services, bringing Texas Grill flavors to every home in Kohat.",
      icon: "📱",
    },
  ];
  ...
  const values = [
    {
      title: "Quality First",
      description: "Only the freshest ingredients, halal certified",
      icon: "🥩",
      color: "red",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter mb-6">
            ...
            <br />
            <span className="bg-gradient-to-r from-[#d8a43f] to-[#cc2b2b] bg-clip-text text-transparent">
              of Kohat
            </span>
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto text-base md:text-lg">
            Where Texas-style grilling meets Pakistani tradition
          </p>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center mb-20 md:mb-32">
          ...
          >
            <div className="aspect-[4/3] relative rounded-2xl md:rounded-3xl overflow-hidden border border-gray-800 shadow-2xl">
              <img
                src={process.env.NEXT_PUBLIC_ABOUT_IMAGE}
          ...
          >
            <span className="text-[#d8a43f] font-bold text-sm uppercase tracking-wider mb-4 inline-block">
              Our Story
            </span>
            <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight mb-6 leading-tight">
              Crafting Perfection
              <span className="block text-[#d8a43f]">Since Day One</span>
            </h2>
            ...
            <div className="space-y-5 text-gray-300 leading-relaxed text-base md:text-lg mb-10">
              <p>{aboutData?.text}</p>
              <p>
                Every portion of our signature dishes is prepared with passion,
                using organic clay pots and traditional methods to bring out the
                pure, authentic taste that Kohat has come to love. From our
                smoky BBQ platters to our sizzling steaks, we engineer memories
                under a fiery grill.
              </p>
            </div>
            <div className="bg-gradient-to-r from-[#1a1a1a] to-[#0f0f0f] border-l-4 border-[#d8a43f] p-6 rounded-r-2xl relative overflow-hidden">
              <div className="absolute top-0 right-0 text-[#d8a43f]/5 text-6xl font-serif">
                "
              </div>
              <p className="relative z-10 text-lg md:text-xl italic font-serif text-white leading-relaxed">
                "We don't just serve food. We engineer memories under a fiery
                grill."
              </p>
              <p className="relative z-10 mt-3 text-sm text-[#d8a43f] font-bold">
                — Chef's Table, Texas Grill
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          {stats.map((stat, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-gray-800 p-6 md:p-8 rounded-2xl text-center group"
            >
              <div
                className={`w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br ${stat.color} rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition`}
              >
              ...
              <p className="text-xs md:text-sm font-bold uppercase text-gray-500 tracking-wider">
                {stat.label}
              </p>
            </motion.div>
          ))}
        ...
        <div className="mb-20 md:mb-32">
          ...
          >
            <span className="text-[#d8a43f] text-sm font-bold tracking-wider uppercase">
              Our Journey
            </span>
            <h2 className="text-3xl md:text-5xl font-black mt-2">
              Milestones That <span className="text-[#d8a43f]">Matter</span>
            </h2>
          </motion.div>
          <div className="relative max-w-4xl mx-auto">
            ...
            {timeline.map((item, idx) => (
              <motion.div
                ...
                className={`relative flex flex-col md:flex-row items-center gap-6 mb-12 md:mb-16 ${idx % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}
              >
                <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-12 h-12 bg-gradient-to-br from-[#d8a43f] to-[#cc2b2b] rounded-full z-20 flex items-center justify-center shadow-xl">
                  <span className="text-white text-xl">{item.icon}</span>
                </div>
                <div
                  className={`w-full md:w-5/12 pl-16 md:pl-0 ${idx % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12"}`}
                >
                  <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-2xl p-6 border border-gray-800 hover:border-[#d8a43f]/50 transition">
                    <span className="inline-block bg-[#cc2b2b] text-white px-3 py-1 rounded-full text-xs font-black mb-3">
                      {item.year}
                    </span>
                    <h3 className="text-xl font-black mb-2 text-[#d8a43f]">
                      {item.title}
                    </h3>
        ...
        >
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-black mt-2">
              Our Core <span className="text-[#d8a43f]">Values</span>
            </h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {values.map((value, idx) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-2xl p-6 text-center border border-gray-800 hover:border-[#d8a43f]/50 transition-all"
              >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-r from-[#cc2b2b] to-[#d8a43f] p-8 md:p-12 text-center"
        >
          <div className="absolute inset-0 bg-black/20"></div>
          <div className="relative z-10">
            <h3 className="text-2xl md:text-4xl font-black mb-4">
              Ready to Experience Texas Grill?
            </h3>
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              Join us for an unforgettable dining experience in the heart of
              Kohat
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/custom-order">
                <button className="px-8 py-3 bg-transparent border-2 border-white text-white font-bold rounded-full hover:bg-white/10 transition">
                  Reserve a Table
                </button>
              </Link>
            </div>
