...
export default function HomePage() {
  ...
  // Images from environment variables
  const heroImages = [
              ...
              <div className="text-center lg:text-left">
                ...
                >
                  <div className="flex flex-col items-center lg:items-start gap-2">
                    ...
                    <p className="text-white font-semibold text-sm">100% Halal</p>
                  ...
                  <div className="flex flex-col items-center lg:items-start gap-2">
                    ...
                    <p className="text-white font-semibold text-sm">Fresh Daily</p>
                  ...
                  <div className="flex flex-col items-center lg:items-start gap-2">
                    ...
                    <p className="text-white font-semibold text-sm">Since 2010</p>
                  ...
                  <div className="relative bg-black/40 backdrop-blur-sm rounded-3xl p-4 border border-white/20 shadow-2xl">
                    ...
                    <div className="grid grid-cols-3 grid-rows-3 gap-3 h-[500px] w-full">
                      <div className="col-span-2 row-span-2 rounded-2xl overflow-hidden relative group">
                        <img src={collageImages.large} alt="BBQ" className="w-full h-full object-cover group-hover:scale-110 transition duration-700" />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition" />
                        <div className="absolute bottom-3 left-3 text-white text-xs font-bold bg-black/50 px-2 py-1 rounded-full backdrop-blur-sm">🔥 Signature BBQ</div>
                      </div>
                      <div className="col-span-1 row-span-1 rounded-2xl overflow-hidden relative group">
                        <img src={collageImages.small1} alt="Burger" className="w-full h-full object-cover group-hover:scale-110 transition duration-700" />
                      </div>
                      <div className="col-span-1 row-span-1 rounded-2xl overflow-hidden relative group">
                        <img src={collageImages.small2} alt="Karahi" className="w-full h-full object-cover group-hover:scale-110 transition duration-700" />
                      </div>
                      <div className="col-span-1 row-span-1 rounded-2xl overflow-hidden relative group">
                        <img src={collageImages.small3} alt="Biryani" className="w-full h-full object-cover group-hover:scale-110 transition duration-700" />
                      </div>
                      <div className="col-span-2 row-span-1 rounded-2xl overflow-hidden relative group">
                        <img src={collageImages.wide} alt="Pizza" className="w-full h-full object-cover group-hover:scale-110 transition duration-700" />
                        <div className="absolute bottom-3 right-3 text-white text-xs font-bold bg-black/50 px-2 py-1 rounded-full backdrop-blur-sm">🍕 Chef's Special</div>
                      </div>
                    ...
                    <div className="absolute -top-4 -right-4 bg-gradient-to-r from-amber-500 to-red-500 text-black px-4 py-2 rounded-full shadow-2xl">
                      <div className="flex items-center gap-2"><span className="text-lg">⭐</span><span className="font-bold text-sm">20+ Signature Dishes</span></div>
                    </div>
              ...
              apiCats.slice(0, 10).map((category) => (
                <div key={category._id} onClick={() => handleCategoryClick(category.slug)} className="group cursor-pointer">
                  <div className="relative overflow-hidden rounded-xl aspect-square bg-gray-900 border border-gray-800">
                    <img src={category.image?.url || category.image} alt={category.name} className="w-full h-full object-cover group-hover:scale-110 transition duration-700" />
                ...
                <div key={item._id} className="group bg-gray-900 rounded-xl overflow-hidden border border-gray-800 hover:border-[#d8a43f]/50 transition-all duration-300">
                  <Link href={`/product/${item._id}`}>
                    <div className="relative h-44 overflow-hidden">
                      <img src={item.image?.url || item.image} alt={item.name} className="w-full h-full object-cover group-hover:scale-110 transition duration-500" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative rounded-xl overflow-hidden shadow-2xl">
                <img src={process.env.NEXT_PUBLIC_RESTAURANT_IMAGE} alt="Texas Grill" className="w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </div>
