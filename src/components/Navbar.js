          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <Link href="/custom-order" className={`font-bold transition duration-300 tracking-wider text-[13px] uppercase flex items-center ${pathname === '/custom-order' ? 'text-[#cc2b2b]' : 'text-[#d8a43f] hover:text-[#cc2b2b]'}`}>
                <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" /></svg>
                VIP
              </Link>
